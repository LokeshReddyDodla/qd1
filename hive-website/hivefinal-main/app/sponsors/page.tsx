...
const partnersData = {
  title: [
    {
      ...
      logo: "/joinasp.jpg",
      link: "https://docs.google.com/forms/d/e/1FAIpQLSdOi_yIWsT4v824lXdnE0UWh6CZ61vsr2nWYtNnFXEjgNkKgQ/viewform?usp=header",
      description:
  ...
  community: [
    ...
    },
    {
      name:"HYD DAO",
      logo:"/hyddao.png",
      link:"https://www.hyderabaddao.com/"
    },
    {
      name:"Friends of Figma",
      logo:"/friendsoffigma.png",
  ...
  return (
    <div className="w-full py-20 bg-white dark:bg-neutral-900">
      <div className="container mx-auto px-4">
        ...
        {Object.entries(partnersData).map(([tier, partners]:any) => (
